...
TEST(FuzzTest, GroupMap) {
  DecodeEncodeArbitrarySchemaAndPayload(
      upb::fuzz::MiniTableFuzzInput{{"$$FF$", "%-C"}, {}, "", {1}},
      std::string(
...
TEST(FuzzTest, MapKeyInDifferentOrderShouldBeEqual) {
  DecodeEncodeArbitrarySchemaAndPayload(
      upb::fuzz::MiniTableFuzzInput{
          {"$GgG9AGGGL?3", "%$1"}, {""}, "", {3079159487}},
      std::string("r\0000\030r\020\032\016\000\000\316\031\272\\\014bT\303\000i"
                  "}|r\020\n\016\000\000\314\031\\\014eTO\000}\216\316|",
                  40),
      2188404, -1755837059, false);
}
