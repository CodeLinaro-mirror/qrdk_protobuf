...
class SourceLocationTest : public testing::Test {
 ...
 protected:
  ...
  void ExpectLocation(const SourceLocation& loc,
    ...
    size_t start_offset = get_offset(loc.start_line, loc.start_column);
    size_t end_offset = get_offset(loc.end_line, loc.end_column);

    ASSERT_NE(start_offset, std::string::npos);
    ASSERT_NE(end_offset, std::string::npos);
    ASSERT_LE(start_offset, end_offset);
    absl::string_view input(kSourceLocationTestInput);
    ASSERT_LE(end_offset, input.size());

    absl::string_view actual_substring =
        input.substr(start_offset, end_offset - start_offset);
    EXPECT_EQ(expected_substring, actual_substring);
  }
};
...
TEST_F(SourceLocationTest, GetSourceLocation) {
  ...
  ExpectLocation(loc, "YES   = 1 [(test_enumval_opt).a = 100];");
  ...
  ExpectLocation(loc, "rpc Method(A) returns (A.B);");
}
...
TEST_F(SourceLocationTest, ExtensionSourceLocation) {
  ...
  ExpectLocation(loc, "repeated int32 int32_extension = 1001 [packed=true];");
  ...
  ExpectLocation(loc, "optional C message_extension = 1002;");
}
...
TEST_F(SourceLocationTest, InterpretedOptionSourceLocation) {
  ...
  // File options
  {
    ...
    ExpectLocation(loc, "option java_package = \"com.foo.bar\";");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 2);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_file_opt) = \"foobar\";");
  ...
  // Message option
  {
    ...
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_msg_opt) = \"foobar\";");
  ...
  // Field option
  {
    ...
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "deprecated = true");
  ...
  // Nested message option
  {
    ...
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "(test_field_opt) = \"foobar\"");
  ...
  // One-of option
  {
    ...
    std::vector<int> vpath(path, path + 6);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_oneof_opt) = \"foobar\";");
  ...
  // Enum option, repeated options
  {
    ...
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_enum_opt) = 21;");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_enum_opt) = 42;");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_enum_opt) = 63;");
  ...
  // Enum value options
  {
    ...
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "(test_enumval_opt).a = 100");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 6);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "(test_enumval_opt) = {a:200}");
  ...
  // Service option, repeated options
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_svc_opt) = {a:100};");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_svc_opt) = {a:200};");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_svc_opt) = {a:300};");
  ...
  // Method options
  {
    ...
    std::vector<int> vpath(path, path + 6);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option deprecated = true;");
  ...
  }
  {
    ...
    std::vector<int> vpath(path, path + 6);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "option (test_method_opt) = \"foobar\";");
  ...
  // Extension range options
  {
    ...
    std::vector<int> vpath(path, path + 5);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "[(test_ext_opt) = \"foobar\"]");
  }
  {
    int path[] = {FileDescriptorProto::kMessageTypeFieldNumber,
                  1,
  ...
  // Field option on extension
  {
    ...
    std::vector<int> vpath(path, path + 4);
    EXPECT_TRUE(file_desc->GetSourceLocation(vpath, &loc));
    ExpectLocation(loc, "packed=true");
