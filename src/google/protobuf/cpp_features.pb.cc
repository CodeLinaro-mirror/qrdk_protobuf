...
constexpr CppFeatures::ParseTableT CppFeatures::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
...
#endif  // !PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const CppFeatures::ParseTableT
