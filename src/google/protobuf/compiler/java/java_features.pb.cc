...
constexpr JavaFeatures_NestInFileClassFeature::ParseTableT JavaFeatures_NestInFileClassFeature::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
...
constexpr JavaFeatures::ParseTableT JavaFeatures::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
...
#endif  // !PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const JavaFeatures_NestInFileClassFeature::ParseTableT
...
#endif  // !PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const JavaFeatures::ParseTableT
