...
void ParseFunctionGenerator::GenerateDataDecls(io::Printer* p) {
  ...
  p->Emit({{"SECTION",
          ...
          R"cc(
            ...
            $SECTION$
            static const ParseTableT _table_;
          )cc");
}
...
void ParseFunctionGenerator::GenerateDataDefinitions(io::Printer* p) {
  ...
  p->Emit(
      R"cc(
        PROTOBUF_CONSTINIT
        PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const $Msg$::ParseTableT
...
void ParseFunctionGenerator::GenerateParseTableHelperDefinition(
  ...
  p->Emit(
      ...
      // clang-format off
R"cc(
constexpr $Msg$::ParseTableT $classname$::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT{
    {
      $table_base$
    }, {{
