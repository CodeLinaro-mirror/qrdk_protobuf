...
// repeated string file_to_generate = 1;
PROTOBUF_ALWAYS_INLINE int CodeGeneratorRequest::_internal_file_to_generate_size()
    const {
...
// repeated .google.protobuf.FileDescriptorProto proto_file = 15;
PROTOBUF_ALWAYS_INLINE int CodeGeneratorRequest::_internal_proto_file_size()
    const {
...
// repeated .google.protobuf.FileDescriptorProto source_file_descriptors = 17;
PROTOBUF_ALWAYS_INLINE int CodeGeneratorRequest::_internal_source_file_descriptors_size()
    const {
...
// repeated .google.protobuf.compiler.CodeGeneratorResponse.File file = 15;
PROTOBUF_ALWAYS_INLINE int CodeGeneratorResponse::_internal_file_size()
    const {
