...
static PyObject* PyUpb_DescriptorPool_FindFileByName(PyObject* _self,
  ...
  if (file == NULL) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find file %R", arg);
  }
...
static PyObject* PyUpb_DescriptorPool_FindExtensionByName(PyObject* _self,
  ...
  if (field == NULL) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find extension %R", arg);
  }
...
static PyObject* PyUpb_DescriptorPool_FindMessageTypeByName(PyObject* _self,
  ...
  if (m == NULL) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find message %R", arg);
  }
...
static PyObject* PyUpb_DescriptorPool_FindFieldByName(PyObject* _self,
  ...
  if (!f) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find field %R", arg);
  }
...
static PyObject* PyUpb_DescriptorPool_FindEnumTypeByName(PyObject* _self,
  ...
  if (e == NULL) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find enum %R", arg);
  }
  ...
  if (child) {
    ...
    if (parent) {
      const upb_OneofDef* o = upb_MessageDef_FindOneofByNameWithSize(
          parent, child, PyObject_Size(arg) - parent_size - 1);
      if (!o) {
        return PyErr_Format(PyExc_KeyError, "Couldn't find oneof %R", arg);
      }
...
static PyObject* PyUpb_DescriptorPool_FindServiceByName(PyObject* _self,
  ...
  if (s == NULL) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find service %R", arg);
  }
...
err:
  return PyErr_Format(PyExc_KeyError, "Couldn't find method %R", arg);
}
...
static PyObject* PyUpb_DescriptorPool_FindFileContainingSymbol(PyObject* _self,
  ...
  if (PyObject_Size(arg) != strlen(name)) {
    return PyErr_Format(PyExc_KeyError, "Couldn't find symbol %R", arg);
  }
